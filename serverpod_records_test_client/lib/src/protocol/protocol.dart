...
import 'package:serverpod_records_test_client/src/protocol/greeting.dart'
    as _i3;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i1.getType<(_i3.Greeting, String)>()) {
      return (
        deserialize<_i3.Greeting>(((data as Map)['p'] as List)[0]),
...
Map<String, dynamic>? mapRecordToJson(Record? record) {
  ...
  if (record is (_i3.Greeting, String)) {
    return {
      "p": [
        record.$1,
        record.$2,
